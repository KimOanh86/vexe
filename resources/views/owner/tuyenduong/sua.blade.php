            ...
            <div class="col-sm-8">
                ...
                {{csrf_field()}}
                    <div class="form-group">
                        <label>ID</label>
                        <input class="form-control" name="id" value="{{$td->id}}" readonly="">
                    </div>
                    <div class="form-group">
                        <label for="id_owner">Id owner</label>
                        <input type="text" class="form-control" id="id_owner" value="{{Auth::user()->id}}" readonly name="id_owner">
                    </div>
                    <div class="form-group">
                      <label for="starting_location">Điểm xuất phát</label>
                      <input list="browsers" value="{{$td->starting_location}}" type="text" class="form-control" id="starting_location" placeholder="Điểm xuất phát" name="starting_location">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text"  value="{{$td->ending_location}}" list="browsers" class="form-control" id="ending_location" placeholder="Điểm đến" name="ending_location">
                      <datalist id="browsers">
                        <option value="An Giang"></option>
                        <option value="Bà Rịa-Vũng Tàu"></option>
                        <option value="Bạc Liêu"></option>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" value="{{$td->number_of_vehicles}}" class="form-control" min="1" max="10" id="amount" placeholder="Số lượng xe" name="amount">
                    </div>
